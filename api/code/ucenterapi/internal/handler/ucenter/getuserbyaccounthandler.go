...
func GetUserByAccountHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := ucenter.NewGetUserByAccountLogic(r.Context(), svcCtx)
		resp, err := l.GetUserByAccount(&req)
		//if err != nil {
		//	httpx.ErrorCtx(r.Context(), w, err)
		//} else {
